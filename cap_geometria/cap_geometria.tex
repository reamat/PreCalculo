...
\colorbox{azul}{
 ...
 Triângulo & 3 & 3 & \includegraphics[width=2cm]{./cap_geometria/figs/pol3.pdf} \\ \hline
 Quadrilátero & 4 & 4 & \includegraphics[width=2cm]{./cap_geometria/figs/pol4.pdf} \\ \hline
 Pentágono & 5 & 5 & \includegraphics[width=2cm]{./cap_geometria/figs/pol5.pdf} \\ \hline
 Hexágono & 6 & 6 & \includegraphics[width=2cm]{./cap_geometria/figs/pol6.pdf} \\ \hline
 Heptágono & 7 & 7 & \includegraphics[width=2cm]{./cap_geometria/figs/pol7.pdf} \\ \hline
 Octógono & 8 & 8 & \includegraphics[width=2cm]{./cap_geometria/figs/pol8.pdf} \\ \hline
 Eneágono & 9 & 9 & \includegraphics[width=2cm]{./cap_geometria/figs/pol9.pdf} \\ \hline
 Decágono & 10 & 10 & \includegraphics[width=3cm]{./cap_geometria/figs/pol10.pdf} \\ \hline
 \end{tabular}
\end{table}
 ...
 \rowcolor{cinza}
 Nome do polígono & Nº de Vértices & Nº de Lados & Polígonos  \\ \hline
 Undecágono & 11 & 11 & \includegraphics[width=3cm]{./cap_geometria/figs/pol11.pdf} \\ \hline
 Dodecágono & 12 & 12 & \includegraphics[width=3cm]{./cap_geometria/figs/pol12.pdf} \\ \hline
 Pentadecágono & 15 & 15 & \includegraphics[width=3cm]{./cap_geometria/figs/pol15.pdf} \\ \hline
 Icoságono & 20 & 20 & \includegraphics[width=3cm]{./cap_geometria/figs/pol20.pdf} \\ \hline
 \end{tabular}
\end{table}
...
\includegraphics[width=4cm]{./cap_geometria/figs/trapezio.pdf}
...
\includegraphics[width=4cm]{./cap_geometria/figs/paralelogramo.pdf}
...
\includegraphics[width=4cm]{./cap_geometria/figs/retangulo.pdf}
...
\includegraphics[width=4cm]{./cap_geometria/figs/losango.pdf}
...
\includegraphics[width=4cm]{./cap_geometria/figs/quadrado.pdf}
...
\centering
 ...
 \multicolumn{3}{|c|}{\textbf{Quanto aos lados}} \\ \hline
  Equilátero & Possui os três lados iguais & \includegraphics[width=3cm]{./cap_geometria/figs/triangulo_equi.pdf} \\ \cline{1-3}
                   Isósceles & Possui dois lados iguais & \includegraphics[width=3cm]{./cap_geometria/figs/triangulo_isos.pdf}\\ \cline{1-3}
                   Escaleno & Possui os três lados diferentes & \includegraphics[width=3cm]{./cap_geometria/figs/triangulo_esc.pdf} \\ \hline
\end{tabular}
\end{table}
...
\centering
 ...
 Obtusângulo & Possui um ângulo medindo mais que $90\degree$ & \includegraphics[width=3cm]{./cap_geometria/figs/triangulo_obt.pdf} \\ \cline{1-3}
   Retângulo & Possui um ângulo reto, que mede $90\degree$ & \includegraphics[width=3cm]{./cap_geometria/figs/triangulo_ret.pdf}
    \\ \cline{1-3}
   Acutângulo & Possui todos os ângulos medindo menos que $90\degree$ & \includegraphics[width=3cm]{./cap_geometria/figs/triangulo_acu.pdf} \\ \hline
 \end{tabular}
\end{table}
...
\includegraphics[width=7cm]{./cap_geometria/figs/triangulo.pdf} \\
...
\textbf{Quadrado}
\begin{multicols}{2}
\includegraphics[width=3cm]{./cap_geometria/figs/quadrado_L.pdf} \\
...
\textbf{Retângulo}
\begin{multicols}{2}
\includegraphics[width=3cm]{./cap_geometria/figs/retangulo_L.pdf} \\
...
\textbf{Paralelogramo}
\begin{multicols}{2}
\includegraphics[width=5cm]{./cap_geometria/figs/paralelogramoL.pdf} \\
...
\textbf{Losango}
\begin{multicols}{2}
\includegraphics[width=3cm]{./cap_geometria/figs/losangoL.pdf} \\
...
\textbf{Trapézio}
\begin{multicols}{2}
\includegraphics[width=5cm]{./cap_geometria/figs/trapezioL.pdf} \\
...
\begin{figure}[H]
\center
\subfigure[ref1][]{\includegraphics[width=6cm]{./cap_geometria/figs/cubo.pdf}}
\qquad
\subfigure[ref2][]{\includegraphics[width=6cm]{./cap_geometria/figs/piramide_quadrada.pdf}}
\end{figure}

\begin{figure}[H]
\center
\subfigure[ref2][]{\includegraphics[width=6cm]{./cap_geometria/figs/prisma_pentagono.pdf}}
\qquad
\subfigure[ref2][]{\includegraphics[width=6cm]{./cap_geometria/figs/cilindro.pdf}}
\qquad
\subfigure[ref2][]{\includegraphics[width=6cm]{./cap_geometria/figs/cone.pdf}}
\qquad
\subfigure[ref2][]{\includegraphics[width=6cm]{./cap_geometria/figs/esfera.pdf}}
...
\begin{multicols}{2}
 \includegraphics[width=5cm]{./cap_geometria/figs/cubo.pdf} \\
...
\begin{multicols}{2}
 \includegraphics[width=6cm]{./cap_geometria/figs/piramide_quadrada.pdf} \\
...
\begin{multicols}{2}
 \includegraphics[width=6cm]{./cap_geometria/figs/prisma_pentagono.pdf} \\
...
\begin{multicols}{2}
 \includegraphics[width=6cm]{./cap_geometria/figs/cilindro.pdf} \\
...
\begin{multicols}{2}
 \includegraphics[width=6cm]{./cap_geometria/figs/cone.pdf} \\
...
\begin{multicols}{2}
 \includegraphics[width=6cm]{./cap_geometria/figs/esfera.pdf} \\
