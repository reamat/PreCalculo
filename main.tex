...
\mainmatter
  ...
  \part{Apêndices}
    ...
    \include{cap_qcregra3/cap_qcregra3}
    \include{cap_mtmfinanceira/cap_mtmfinanceira}
    \include{cap_qcmtmfinanceira/cap_qcmtmfinanceira}
    \include{cap_sistlin/cap_sistlin}
    \include{cap_qcsistlin/cap_qcsistlin}
    \include{cap_geometria/cap_geometria}
    \include{cap_qcgeometria/cap_qcgeometria}
