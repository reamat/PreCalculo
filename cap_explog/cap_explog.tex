...
\chapter{Funções exponenciais e logarítmicas}
 ...
 \begin{exem}\label{ex:exp-2}
  ...
  \begin{figure}[H]
  \centering
    \fbox{\includegraphics[width=7cm]{./cap_explog/figs/f(x)=2^x.pdf}}
 ...
 \end{exem}
  ...
  \begin{figure}[H]
  \centering
    \fbox{\includegraphics[width=7cm]{./cap_explog/figs/f(x)=0_5^x.pdf}}
 ...
 Para facilitar a comparação dos gráficos das funções dos dois últimos exemplos observe o plano cartesiano abaixo no qual temos os dois gráficos, note que eles são simétricos em relação ao eixo $y$.
   ...
   \begin{figure}[H]
 \centering
    \fbox{\includegraphics[width=8cm]{./cap_explog/figs/comparandoexponenciais.pdf}}
  ...
  \begin{figure}[H]
 \centering
    \fbox{\includegraphics[width=7cm]{./cap_explog/figs/f(x)=e^x.pdf}}
 ...
 \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=7cm]{./cap_explog/figs/h(x)=log_2.pdf}}
 ...
 \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=7cm]{./cap_explog/figs/h(x)=log_12.pdf}}
 ...
 Para facilitar a comparação dos gráficos das funções dos dois últimos exemplos observe o plano cartesiano abaixo no qual temos os dois gráficos, note que eles são simétricos em relação ao eixo $x$.
   ...
   \begin{figure}[H]
 \centering
    \fbox{\includegraphics[width=8cm]{./cap_explog/figs/comparandologs.pdf}}
  ...
  esta função é chamada logaritmo neperiano, que é uma função crescente, e seu gráfico é:
   ...
   \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=7cm]{./cap_explog/figs/f(x)=ln(x).pdf}}
 ...
 \end{exem}
  ...
  \begin{enumerate}
   ...
   \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=9cm]{./cap_explog/figs/comparandobase2.pdf}}
   ...
   \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=9cm]{./cap_explog/figs/comparandobase1-2.pdf}}
   ...
   \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=9cm]{./cap_explog/figs/comparandobase-e.pdf}}
