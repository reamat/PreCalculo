...
Antes de usar esta fórmula específicamente para resolver as equações do 2º grau vejamos alguns casos particulares de equações do 2º grau que podemos resolver sem esta fórmula.
 ...
 \[7x^2 - \sqrt{98}x=0 \Rightarrow x \cdot (7x - \sqrt{98})= 0 \Rightarrow 
 \begin{cases}
 x_1=0 \\
 7x - \sqrt{98}=0 \Rightarrow 7x = \sqrt{7^2 \cdot 2} \Rightarrow x= \frac{7\sqrt{2}}{7} \Rightarrow x_2= \sqrt{2} \ .
 \end{cases} 
 \]
...
\textbf{Caso 5:} Neste caso vamos considerar as equações do tipo
\[(x+a)\cdot (x+b)= 0\]
...
Acabamos de ver vários tipos de equações do 2º e como resolve-lás, então cabe aqui ver um exemplo prático de aplicação das equações do 2º grau para resolução de problemas.
