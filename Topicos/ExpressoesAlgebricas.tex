\chapter{Expressões algébricas (melhorar)}
...
\section{Operações Algébricas}
 ...
 %\section{Expressões algébricas com frações (fazer)}
 
 \section{Expressões algébricas com módulos}% (fazer)}
...
\end{table}
 ...
 %\section{Expressões algébricas com raízes (fazer)}
