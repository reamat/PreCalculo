...
\vskip0.4cm
 ...
 As relações entre conjuntos podem ser representadas através de diagramas de Venn (ou diagramas de Euler), nos quais basicamente desenhamos um retângulo para representar o conjunto universo, dentro deste retângulo desenhamos um círculo para representar cada conjunto, e dentro de cada círculo escrevemos os elementos que pertencem ao conjunto correspondente.
