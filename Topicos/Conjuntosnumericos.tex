...
\begin{enumerate}
 ...
 \begin{enumerate}
 \begin{multicols}{2}
 \item $-3 \underline{\hspace{1cm}} \N$
 \item $-102 \underline{\hspace{1cm}} \Z$
 \item $0,25 \underline{\hspace{1cm}} \Q$
 \item $\pi \underline{\hspace{1cm}} \I$
 \item $\sqrt{3} \underline{\hspace{1cm}} \R$
 \item $(-6)^2 \underline{\hspace{1cm}} \N$
 \item $\frac{2}{5} \underline{\hspace{1cm}} \Z$
 \item $\frac{7}{9} \underline{\hspace{1cm}} \Q$
 \item $e \underline{\hspace{1cm}} \I$
 \item $\sqrt{-4} \underline{\hspace{1cm}} \R$
 \end{multicols}
 \end{enumerate}
