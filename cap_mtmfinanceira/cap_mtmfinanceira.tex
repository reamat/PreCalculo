...
\end{table}
 ...
 \destaque{M= C + J = C + C \cdot n \cdot i \Rightarrow M=  C \cdot (1 + n \cdot i)}
 ...
 \begin{itemize}
  ...
  \destaque{M=C+J \Rightarrow J= M-C \Rightarrow J= C(1+i)^n - C \Rightarrow J= C((1+i)^n - 1)}.

  \item Cálculo do capital:
  
  \destaque{M= C(1+i)^n \Rightarrow C= \frac{M}{(1+i)^n}}.
  
  \item Cálculo da taxa:
  
  \destaque{M= C(1+i)^n \Rightarrow (1+i)^n= \frac{M}{C} \Rightarrow 1+i= \left(\frac{M}{C}\right)^{1/n} \Rightarrow i= \left(\frac{M}{C}\right)^{1/n} -1}
