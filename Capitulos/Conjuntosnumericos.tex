...
\begin{prop} [Propriedades da relação de ordem] \label{prop.ordem} Dados $x, y, z \text{ e } w \in \R$ temos que:
\begin{enumerate}
...
Este conceito de ordem dos números reais nos permite representá-los como pontos sobre uma reta orientada, chamada \textbf{reta real}, assim como representamos os anos em uma reta cronológica, e as temperaturas aparecem em ordem em um termômetro.
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=15cm]{Capitulos/Figuras/RetaCronologica.pdf}
...
Note que, se tivermos $b=0$, estamos com o conjunto dos números reais, portanto $\R \subset \C$. Para fixar a ordem de continência destes conjuntos numéricos, observemos o diagrama de Venn abaixo.
 ...
 \begin{figure}[H]
 \centering
    \fbox{\includegraphics[width=7.5cm]{Capitulos/Figuras/diagrama_conjuntos.pdf}}
...
\begin{itemize}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=3.5cm]{Capitulos/Figuras/aberto-a-aberto-b.pdf}
 \end{figure}
 \item Intervalo fechado: $[a, b]= \{x \in \R \mid a \leq x \leq b\}$;
 \begin{figure}[H]
 \centering
 \includegraphics[width=3.5cm]{Capitulos/Figuras/fechado-a-fechado-b.pdf}
 \end{figure}
 \item Intervalo aberto à direita e fechado à esquerda: $[a, b[= \{x \in \R \mid a \leq x < b\}$;
 \begin{figure}[H]
 \centering
 \includegraphics[width=3.5cm]{Capitulos/Figuras/fechado-a-aberto-b.pdf}
 \end{figure}
 \item Intervalo aberto à esquerda e fechado à direita: $]a, b]= \{x \in \R \mid a < x \leq b\}$.
 \begin{figure}[H]
 \centering
 \includegraphics[width=3.5cm]{Capitulos/Figuras/aberto-a-fechado-b.pdf}
 \end{figure}
\end{itemize}
...
\item Conjunto dos números reais maiores que $a$: $[a, +\infty[ = \{ x \in \R \mid a < x \}$
 \begin{figure}[H]
 \centering
 \includegraphics[width=3.5cm]{Capitulos/Figuras/aberto-a-inf.pdf}
 \end{figure}

\item Conjunto dos números reais maiores ou iguais à $a$: $[a, +\infty[ = \{ x \in \R \mid a \leq x \}$
 \begin{figure}[H]
 \centering
 \includegraphics[width=3.5cm]{Capitulos/Figuras/fechado-a-inf.pdf}
 \end{figure}

\item Conjunto dos números reais menores que $b$: $]-\infty, b] = \{ x \in \R \mid x < b \}$
 \begin{figure}[H]
 \centering
 \includegraphics[width=3.5cm]{Capitulos/Figuras/inf-aberto-b.pdf}
 \end{figure}

\item Conjunto dos números reais menores ou iguais à $b$: $]-\infty, b] = \{ x \in \R \mid x \leq b \}$
 \begin{figure}[H]
 \centering
 \includegraphics[width=3.5cm]{Capitulos/Figuras/inf-fechado-b.pdf}
 \end{figure}

\item Conjunto dos números reais: $]-\infty, +\infty[ = \R$
 \begin{figure}[H]
 \centering
 \includegraphics[width=7.5cm]{Capitulos/Figuras/reta.pdf}
 \end{figure}
\end{itemize}
